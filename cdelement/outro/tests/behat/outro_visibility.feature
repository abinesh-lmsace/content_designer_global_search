# @mod @mod_contentdesigner @cdelement_outro @_file_upload @javascript
...
#     And I upload "mod/contentdesigner/cdelement/outro/tests/behat/assets/c1.jpg" file to "Image" filemanager
