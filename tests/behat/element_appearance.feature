...
#       | Title         | Heading 02 |
#     And I press "Create element"
#     And I click on ".chapters-list:nth-child(3) .contentdesigner-addelement .fa-plus" "css_element"
#     And I click on ".elements-list li[data-element=heading]" "css_element" in the ".modal-body" "css_element"
#     And I set the following fields to these values:
#       | Heading text  | Heading 03 |
#       | Title         | Heading 03 |
#     And I press "Create element"
#     And I click on ".chapters-list:nth-child(3) .contentdesigner-addelement[data-position=\"bottom\"] .fa-plus" "css_element"
#     And I click on ".elements-list li[data-element=heading]" "css_element" in the ".modal-body" "css_element"
#     And I set the following fields to these values:
#       | Heading text  | Heading 04 |
#       | Title         | Heading 04 |
#     And I press "Create element"
#     And I should see "Heading 01" in the ".course-content-list .chapters-list:nth-child(2) li.element-item:nth-child(1)" "css_element"
#     And I should see "Heading 02" in the ".course-content-list .chapters-list:nth-child(2) li.element-item:nth-child(2)" "css_element"
#     And I should see "Heading 03" in the ".course-content-list .chapters-list:nth-child(3) li.element-item:nth-child(1)" "css_element"
#     And I should see "Heading 04" in the ".course-content-list .chapters-list:nth-child(3) li.element-item:nth-child(2)" "css_element"
...
#     And I should not see "Heading 01" in the ".chapters-list:nth-child(2) li.element-item:nth-child(1)" "css_element"
#     And I should see "Heading one" in the ".course-content-list .chapters-list:nth-child(2) li.element-item:nth-child(1)" "css_element"
#     And I click on ".chapters-list:nth-child(2) li.element-item:nth-child(1) .action-item[data-action=delete]" "css_element"
...
#     And I should not see "Heading one" in the ".chapters-list:nth-child(2) li.element-item:nth-child(1)" "css_element"
